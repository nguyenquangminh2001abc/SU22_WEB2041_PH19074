<?php 
    ...
    {
        header("location: ./cap_nhap_thong_tin_tai_khoan.php");
        die;
    }
    else{
...
<body>
    ...
    <main class="main">
        <section>
            <article>
                <h5>ADMIN CẬP NHẬP THÔNG TIN TÀI KHOẢN</h5>
            </article>
            <article>
            ...
            <article>
                <button type="button" onclick=" window.location='add_khach_hang.php'"
                    class="btn btn-primary btn-sm">TRANG CHỦ</button>
                <button type="button" onclick=" window.location='index.php'" class="btn btn-success btn-sm">THÔNG TIN TÀI KHOẢN</button>
            </article>
        </section>
        <section>
